...
export default function Hero() {
	...
	const { setRef: setHeroRef, wasViewed } = useWasViewed();
	const { setRef: setIMGRef, wasViewed:wasIMGViewed } = useWasViewed();
	const animationHero = wasViewed ? 'animate-fade-in-up delay-200' : null 
	const animationIMG = wasIMGViewed? 'animate-fade-in-up delay-200' : null
			...
			<div className=' box-gradient py-4 md:py-8 xl:py-16 rounded-2xl mx-4 md:mx-8 2xl:mx-14 lg:pl-10 overflow-hidden px-4' ref={setRef}>
				<div className=' box-screen'>
					<div className=' flex flex-wrap items-center -mx-4 gap-y-12'>
						<div className=' w-full lg:w-1/2 px-4' ref={setHeroRef}>
							<div className={animationHero} ref={setHeroRef}>
						...
						<div className=' w-full lg:w-1/2 px-4'>
							<div className={animationIMG} ref={setIMGRef}>
