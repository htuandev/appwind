...
const Box = ({plan}) => {
	...
	return (
		<div className=' w-full md:w-1/2 lg:w-1/3 px-4 select-none'>
			<div className=' rounded-3xl border-[#EEF3FF] dark:border-[#07102D] border-[2px] overflow-hidden mb-12 relative px-8 py-10 sm:p-12 md:p-8 lg:p-5 xl:p-9 2xl:p-12 hover:border-primary dark:hover:border-primary cursor-pointer'>
